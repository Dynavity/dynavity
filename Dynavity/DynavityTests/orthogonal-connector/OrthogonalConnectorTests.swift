...
class OrthogonalConnectorTests: XCTestCase {
    ...
    func testCreateGraph() {
        let points = grid.generateGridPoints(toElement: destinationUmlElement)
    ...
    func testGenerateRoute_middleLeftToMiddleRight_returnsOrthogonalPath() {
        ...
        XCTAssertEqual(path[4], CGPoint(x: 165.0, y: 915.0))
        XCTAssertEqual(path[5], CGPoint(x: 250.0, y: 915.0))
        XCTAssertEqual(path[6], CGPoint(x: 335.0, y: 915.0))
    ...
    func testGenerateRoute_middleBottomToMiddleBottom_returnsOrthogonalPath() {
        ...
        XCTAssertEqual(path[4], CGPoint(x: 250.0, y: 1_000.0))
        XCTAssertEqual(path[5], CGPoint(x: 250.0, y: 1_042.5))
    ...
    func testGenerateRoute_middleTopToMiddleBottom_returnsOrthogonalPath() {
        ...
        XCTAssertEqual(path[6], CGPoint(x: 250.0, y: 1_000.0))
        XCTAssertEqual(path[7], CGPoint(x: 250.0, y: 1_042.5))
        XCTAssertEqual(path[8], CGPoint(x: 250.0, y: 1_085.0))
